...
macro(firebreath_sign_file PROJNAME _FILENAME PFXFILE PASSFILE ADDITIONAL_CERTS TIMESTAMP_URL)
    if (WIN32)
        if (EXISTS ${PFXFILE})
            ...
            if (SIGNTOOL)
				...
				if (NOT "${ADDITIONAL_CERTS}" STREQUAL "")
                    set(_STCMD ${_STCMD} /ac "${ADDITIONAL_CERTS}")
                endif()
...
macro(firebreath_sign_plugin PROJNAME PFXFILE PASSFILE  ADDITIONAL_CERTS TIMESTAMP_URL)
    if (WIN32)
        ...
        firebreath_sign_file("${PROJNAME}" "${_PLUGFILENAME}" "${PFXFILE}" "${PASSFILE}"  "${ADDITIONAL_CERTS}" "${TIMESTAMP_URL}")
    endif()
